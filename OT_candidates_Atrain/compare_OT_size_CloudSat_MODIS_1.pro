...
pro compare_OT_size_CloudSat_MODIS_1
...
;	ct=colorbar(target=c1,position=[pos[0]+0.1,pos[3]-0.15,pos[2]-0.1,pos[3]-0.13])
	...
	save,colocate_bt11,colocate_bt11_np,colocate_bt67,colocate_bt11_sm,colocate_bt67_sm,colocate_lat_parallax,colocate_lon_parallax,$
	...
	; delete some variables to save memory
  	delvar,modis_bt11_gs,modis_bt67_gs,diffdis,modlat,modlon,modlat_parallax,modlon_parallax,$
		cldtop,latscp,lonscp,lon,lat,height,radar_ze,r_parallax,sensorrazimuth,sensorzenith,$
...
;  jump1:
  ...
  OT_BT11_1=OT_BT11.ToArray()	
  OT_BT67_1=OT_BT67.ToArray()	
  ...
  save,OT_lon1,OT_lat1,OT_size_Cldsat1,OT_size_modis1,OT_BT11_1,OT_BT67_1,OT_vis_1,OT_above_trop_cld_1,OT_above_trop_mod_1,trop_merra2_T1,$
	OT_location_cld,OT_location_mod,OT_filename,$
	filename=strcompress('CloudSat_MODIS_OT_2007'+string(i)+'_dbz25.sav',/rem)
  print,systime()
  stop
