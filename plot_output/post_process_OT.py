...
#years=['2002','2003','2004','2005','2006','2007','2008','2009','2010']#,'2019','2020']
years=['2021']#,'2003','2004','2005','2006','2007','2008','2009','2010','2011','2012',\
...
for year in years:
    ...
    hy5file='/data/keeling/a/yulanh/c/OT_climatology/Aqua_MODIS_OTNOT_nopolygon_'+year+'.h5'
    ...
    for fname in fnames:
        ...
        if (file_size > 0) :
            ...
            #mod03fname=glob.glob('/data/gdi/e/MODIS/MYD03/'+year+'/'+Julday+'/MYD03.A'+yyyymmdd+'*')
            mod03fname=glob.glob('/data/gdi/f/yulanh/MODIS/MYD03/'+year+'/'+Julday+'/MYD03.A'+yyyymmdd+'*')
            #print(mod03fname)
            hdf=SD(mod03fname[0])
