...
pro compare_OT_size_CloudSat_MODIS_2
 ...
 ; in this version using MERRA2 tropopause height
  ...
  dir='/data/keeling/a/yulanh/c/BW_backup/CloudSat/2B-GEOPROF/2007/'
...
;	if i lt 300 then goto,jump1
	...
	cldclass_fname='/data/keeling/a/yulanh/c/BW_backup/CloudSat/2B-CLDCLASS-LIDAR/2007/'+strflag+'_CS_2B-CLDCLASS-LIDAR_GRANULE_P1_R05_E02_F00.hdf'
    ...
    print,'time',hhmm,time[OTinfo_si],lon[OTinfo_si],lat[OTinfo_si]
...
;	print,mod03_fname
	...
	merra2_fname=strcompress('/data/keeling/a/yulanh/c/MERRA-2/2007/'+'MERRA2_300.inst1_2d_asm_Nx.2007'+$
...
;			print,si,ii,diffdis[disind[0]],tpcldlat,tpcldlon,modlon_parallax[res_scp[0],res_scp[1]],modlat_parallax[res_scp[0],res_scp[1]],modis_bt11_gs[res_scp[0],res_scp[1]]
...
;			print,ii,diffdis[disind[0]],tpcldlat,tpcldlon,modlon_parallax[res_scp[0],res_scp[1]],modlat_parallax[res_scp[0],res_scp[1]],modis_bt11_gs[res_scp[0],res_scp[1]]
	...
	colocate_bt11_sm= colocate_bt11;imsl_spvalue(x2,pp)
	;pp=imsl_cssmooth(x,colocate_bt67)
	colocate_bt67_sm= colocate_bt67;imsl_spvalue(x2,pp)
	;first derivative 
	...
	c1=contour(transpose(tpradar_ze)/100.0,tpcldlat,reform(tpheight[*,151]),$
		rgb_table=62,c_value=c_level,/fill,xtitle='Lat',ytitle='Alt. (km)',yrange=[0,27],$
...
;  jump1:
  ...
  save,OT_lon1,OT_lat1,OT_size_Cldsat1,OT_size_modis1,OT_center_BT11_1,OT_center_BT67_1,OT_vis_1,OT_above_trop_cld_1,OT_above_trop_mod_1,trop_merra2_T1,$
	...
	filename=strcompress('CloudSat_MODIS_OT_2007'+string(i)+'_dbz25_update.sav',/rem)
  print,systime()
  stop
